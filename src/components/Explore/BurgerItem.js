...
const BurgerItem = ({ burger }) => {
    const { _id, name, img, text, cal, fat, price, rating } = burger;
                ...
                <div className='h-100 pb-4 d-flex flex-column justify-content-between shadow-lg bg-warning rounded-10'>
                    ...
                    <div className='pb-3 px-3'>
                        <small className='d-flex justify-content-between'>
                            ...
                            <span className='d-block fw-bolder text-dark'>{rating} <i class="ps-1 fas fa-star"></i></span>
                        </small>
                    </div>
                    <div className='pb-3 px-3'>
                    ...
                    <div className='px-3'>
                        <button onClick={() => handleBurgerDeatils(_id)} className='btn btn-dark'>Details <i class="ps-2 fas fa-arrow-right"></i></button>
                    </div>
                </div>
            </div>
        </div >
