            ...
            <div className="container px-4">
                <div className="py-4 row justify-content-between text-start">
                    <div className="mt-4 col-lg-2 col-sm-6 order-lg-2 order-xs-2">
                        ...
                        <Link className="my-2 text-decoration-none d-block text-secondary foo-hover" to="/info">FAQ</Link>
                        <Link className="my-2 text-decoration-none d-block text-secondary foo-hover" to="/feedback">Feedback</Link>
                        <Link className="my-2 text-decoration-none d-block text-secondary foo-hover" to="/career">Career</Link>
                        <Link className="my-2 text-decoration-none d-block text-secondary foo-hover" to="/payment">Payment Options</Link>
                        <Link className="my-2 text-decoration-none d-block text-secondary foo-hover" to="/return">Return Policy</Link>
                    </div>
                    ...
                    <div className="mt-4 col-lg-4 col-sm-12 order-lg-1 order-xs-3">
                        ...
                        <small className="text-secondary d-block"><span className="text-white pe-1">Gatsbee Corporatiopn </span> is a Bangladeshi multinational fast food corporation, founded in 2010 as a restaurant operated by Tanmay & Thomas Gatsby, in Dhaka, Bangldesh.</small>
                        ...
                        <small className="text-secondary">Copyright &copy; 2022. <span className="text-light">Tanmay Kumar.</span></small>
                        <div>
